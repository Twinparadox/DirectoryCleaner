...
namespace DirectoryCleaner
{
	public static class Extension
	{
		...
		public static string defaultCompacExtension = "ace,alz,bz2,egg,gz,jar,rar,tar,xz,zip,7z";
		public static string defaultDevelopeExtension = "c,cs,css,cpp,hpp,h,java,jav,js,kt,py,php";
